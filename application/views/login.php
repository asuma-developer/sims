...
<div class="login-box">
  <div class="login-logo">
    <a href="../../index2.html">SIMS</a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    <p class="login-box-msg">Sign in to start your session</p>

    <form action="<?php echo base_urL('index.php/sims/login');?>" method="post">
      <div class="form-group has-feedback">
        <input name="nip" type="number" class="form-control" placeholder="NIP" required>
